<?php
/* Smarty version 3.1.30, created on 2020-02-28 15:40:42
  from "D:\wamp64\www\server\smart_dir\tpl\header_form.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5e59347aed2fc2_38551045',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'acdf91f639673ffb16f2c07360db506141410c5d' => 
    array (
      0 => 'D:\\wamp64\\www\\server\\smart_dir\\tpl\\header_form.html',
      1 => 1582904396,
      2 => 'file',
    ),
  ),
...
function content_5e59347aed2fc2_38551045 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="ctrl">
...
<form class="show-form header-form form-reset form-static">
  ...
  <div class="form-group">
    ...
    <div class="time_box">
      <?php if (isset($_smarty_tpl->tpl_vars['showtime']->value) && $_smarty_tpl->tpl_vars['showtime']->value) {?>
      ...
      <?php }?>
      <i class="tip-info" style="color:;">(若有多个单位则使用"+"隔开)</i>
    </div>
...
">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="addr" name="addr" placeholder="举办地址" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['addr']->value)===null||$tmp==='' ? '成都新会展中心' : $tmp);?>
">
  </div>
  <div class="form-group">
    <label for="zhuban">主办方</label>
    <input type="text" class="form-control" id="zhuban" name="zhuban" placeholder="主办方" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['zhuban']->value)===null||$tmp==='' ? '' : $tmp);?>
">
  </div>
  <div class="form-group">
...
">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="xieban" name="xieban" placeholder="协办方" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['xieban']->value)===null||$tmp==='' ? '' : $tmp);?>
">
  </div>
  <div class="form-group">
