...
function run () {
  ...
  add_user_info ();
  // 添加script标签
  // var base = $('<script type="text/javascript" src="../static/js/base.js"></script>');
  // var form = $('<script type="text/javascript" src="../static/js/form.js"></script>');
  // var main_form = $('<script type="text/javascript" src="../static/js/mainform.js"></script>');
  // var control = $('<script type="text/javascript" src="../static/js/control.js"></script>');
  // $('body').append(base).append(form).append(main_form).append(control);
}
  ...
  $.get(URL.userINFO, function (res) {
    ...
    if (res !== '') {
      ...
      if (user) {
        ...
        var _btn = $('<a href="javascript:;" id="exit">退出</button>');
        $('#user-info').html('');
